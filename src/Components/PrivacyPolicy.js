...
To provide the Services, we collect information about you from a variety of sources, as set out below. The information that we collect and use varies depending on how you interact with us. In addition to the specific uses set out below, we may use information we collect about you to communicate with you, provide the Services, comply with any applicable legal obligations, enforce any applicable terms of service, and to protect or defend the Services, our rights, and the rights of our users or others.
...
Basic contact details including your name, address, phone number, email etc.
...
We may disclose your Personal Information for the purposes outlined in this Privacy Policy, including but not limited to: Shipping Partners: We may share your name, address, and contact information with shipping partners to facilitate the delivery of products purchased through our website. This information is necessary for the fulfillment of orders and may include details such as delivery instructions provided by you. Our shipping partners are contractually obligated to use your Personal Information only for the purpose of delivering the products and are required to maintain the confidentiality and security of your information in accordance with applicable laws and regulations. Payment Service Providers: We may share your Personal Information with payment service providers to process transactions made through our website. This may include your name, billing address, payment card information, and other relevant details necessary to complete the transaction. Please note that we do not store or retain your payment card information on our servers. All payment transactions are processed securely through our payment service providers, who are responsible for adhering to industry-standard security protocols and compliance with applicable payment card industry regulations. It's important to understand that while we take reasonable steps to ensure the security of your Personal Information when disclosing it to third parties, we cannot guarantee the security of information transmitted to or from our website.
